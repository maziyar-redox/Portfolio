    ...
    return (
        <div className="flex flex-col items-center justify-center px-0 md:px-10 pt-10 pb-16 md:pt-24 md:mt-0 space-y-8 lg:space-y-16">
            ...
            <div className="relative">
                ...
                <Input placeholder="Search..." className="rounded-full pl-8 pr-28 focus-visible:ring-0 focus-visible:border-white-shade-90 focus-visible:ring-offset-0" type="text" />
            </div>
