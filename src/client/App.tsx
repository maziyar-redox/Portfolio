...
import { ArrowRightIcon, ArrowSquareOutIcon, CodeIcon, CpuIcon, DatabaseIcon, GithubLogoIcon, LinkedinLogoIcon, MailboxIcon, TerminalIcon } from "@phosphor-icons/react";
    ...
    return (
        ...
        >
            ...
            {projects.map((project, index) => (
                ...
                <CardFooter className="flex justify-between pt-0">
                    ...
                    >
                    LIVE DEMO <ArrowSquareOutIcon className="size-3" />
                    </a>
                    <a
                    href={project.repo}
                    className="text-sm font-display flex items-center hover:text-primary transition-colors gap-2"
                    >
                    CODE <GithubLogoIcon className="size-3" />
                    </a>
                </CardFooter>
                </Card>
            ))}
        ...
        >
            ...
            <div className="md:col-span-4">
                ...
                <div className="p-4 border border-border bg-background flex flex-col items-center justify-center aspect-square hover:border-primary transition-colors">
                    <CpuIcon className="h-8 w-8 mb-2 text-primary" />
