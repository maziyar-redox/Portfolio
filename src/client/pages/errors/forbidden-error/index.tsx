...
import { ForbiddenErrorPageMetaData } from "@/client/core/constants/metadata";
...
function ForbiddenErrorPage() {
    return (
        <>
            <Helmet>
                <title>
                    {ForbiddenErrorPageMetaData.title}
                </title>
                <meta name="description" content={ForbiddenErrorPageMetaData.description} />
                <meta name="keywords" content={ForbiddenErrorPageMetaData.keywords.join(" ,")} />
