...
import { NotfoundErrorPageMetaData } from "@/client/core/constants/metadata";
...
function NotFoundPage() {
    return (
        <>
            <Helmet>
                <title>
                    {NotfoundErrorPageMetaData.title}
                </title>
                <meta name="description" content={NotfoundErrorPageMetaData.description} />
                <meta name="keywords" content={NotfoundErrorPageMetaData.keywords.join(" ,")} />
